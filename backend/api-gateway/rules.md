...
## Overview
API Gateway теперь основан на **PyApiGate** — внешнем FastAPI-сервисе (образ `ghcr.io/misha00025/pyapi-gate:0.2.0`).
...
| `ctx.request.get_json()` | `ctx.request.json` (property, response handlers) |
...
| `build: context: ./api-gateway` | `image: ghcr.io/misha00025/pyapi-gate:0.2.0` |
